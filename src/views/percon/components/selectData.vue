    ...
    <div style="display:flex;">
      <div style="width:45%;border:1px solid #ddd;height:500px;overflow-y:scroll;">
        <div style="background-color:#eee;padding:6px 8px;">
          <el-checkbox v-model="leftFlag" :indeterminate="indeterminateLeft">未授权</el-checkbox>
        </div>
        <div v-for="(item,index) in datal" :key="index" style="padding:6px 8px;">
          <el-checkbox v-model="item.select" @change="oneMenu(item)">{{ item.name }}</el-checkbox>
      ...
      <div style="width:45%;border:1px solid #ddd;height:500px;overflow-y:scroll;">
        <div style="background-color:#eee;padding:6px 8px;">
          <el-checkbox v-model="rightFlag" :indeterminate="indeterminateRight">已授权</el-checkbox>
        </div>
